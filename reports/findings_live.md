...
Leakage in the other direction — substantive answers to requests the taxonomy marks as prohibited — was 14.2% (n=485). Pooled precision on the refuse class was 0.78 and recall 0.86: the models catch most of what the policy asks them to catch, and pay for it with a large number of false positives on legitimate traffic.
